...
export const firestickSection: GuideSectionData = {
  ...
  blocks: [
    ...
    {
      type: "p",
      text: "Open Downloader and enter downloader code {{code}}. Check that the displayed download belongs to Telvis. Do not install files from unrelated search results or unverified messages.",
    },
