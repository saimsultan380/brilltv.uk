...
import { getWhatsAppLink, routes } from "@/lib/site";
...
const sharedFeatures = [
  ...
  { text: "Installation guidance", icon: MonitorPlay },
...
const plans = [
  ...
  },
  {
    ...
    title: "3-Month Plan",
    price: "£24.99",
    perMonth: "Approximately £8.33 per month",
    summary:
      "A balanced three-month option with a lower average monthly cost than purchasing separate monthly plans.",
    cta: "Choose 3 Months",
  ...
  },
  {
    ...
    title: "6-Month Plan",
    price: "£39.99",
    perMonth: "Approximately £6.67 per month",
    summary:
      "A practical choice after completing the trial and confirming that the service works correctly on your preferred device and connection.",
    cta: "Choose 6 Months",
  ...
  },
  {
    ...
    title: "12-Month Plan",
    price: "£49.99",
    perMonth: "Approximately £4.17 per month",
    summary:
      "The lowest average monthly cost. Choose this plan after testing the service and confirming your normal viewing setup.",
    ...
    >
      <div className="telvis-section-inner">
        <SectionHeader
          ...
          lead="Choose the subscription length that suits you. Start with one month for flexibility or select a longer plan for a lower average monthly cost. Every IPTV UK plan includes the same core catalogue, access methods and customer support."
        />
        ...
        <div className="telvis-plan-grid">
          {plans.map((plan, index) => (
            ...
            >
              ...
              <CardRevealPart variant="content">
                <a
                  href={getWhatsAppLink(`I would like to order the ${plan.title} (${plan.price}).`)}
                  target="_blank"
